use crate::{
    auth::Claims, database::DatabasePool, db, errors::ServError, helpers::respond_json,
    models::User,
};
...
/// Get a user
pub async fn get_user(pool: Data<DatabasePool>, claim: Claims) -> Result<Json<User>, ServError> {
